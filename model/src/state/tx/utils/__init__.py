...
def get_lightning_module(model_type: str, data_config: dict, model_config: dict, training_config: dict, var_dims: dict):
    ...
    elif model_type.lower() == "vae_transition":
        from ...tx.models.vae_transition import VAETransitionPerturbationModel

        return VAETransitionPerturbationModel(
            input_dim=var_dims["input_dim"],
            gene_dim=gene_dim,
            hvg_dim=var_dims["hvg_dim"],
            output_dim=var_dims["output_dim"],
    ...
    elif model_type.lower() == "de_transition":
        from ...tx.models.de_transition import DETransitionPerturbationModel

        return DETransitionPerturbationModel(
            input_dim=var_dims["input_dim"],
            gene_dim=gene_dim,
            hvg_dim=var_dims["hvg_dim"],
            output_dim=var_dims["output_dim"],
