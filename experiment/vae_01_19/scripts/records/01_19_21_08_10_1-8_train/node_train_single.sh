...
python -m state tx train \
    ...
    model.kwargs.loss_kwargs.main_loss_kwargs.type=${MAIN_LOSS} \
    model.kwargs.loss_kwargs.vae_loss_kwargs.use_vae_loss=${USE_VAE_LOSS} \
    model.kwargs.loss_kwargs.vae_loss_kwargs.type=${VAE_LOSS} \
    model.kwargs.loss_kwargs.vae_loss_kwargs.weight=${VAE_LOSS_WEIGHT} \
