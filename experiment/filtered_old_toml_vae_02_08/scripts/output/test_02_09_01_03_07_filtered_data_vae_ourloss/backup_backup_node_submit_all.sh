...
# export STAGE=train
export STAGE=test
export CONFIG_NAME="filtered_data_vae_ourloss"
...
bash ${BASH_PATH} jurkat ${STAGE} ${CONFIG_NAME} 0 ba &

bash ${BASH_PATH} hepg2 ${STAGE} ${CONFIG_NAME} 1 ba &

bash ${BASH_PATH} k562 ${STAGE} ${CONFIG_NAME} 2 ba &

bash ${BASH_PATH} rpe1 ${STAGE} ${CONFIG_NAME} 3 ba &
