...
# export STAGE=train
export STAGE=test
export CONFIG_NAME="vae_ourloss_lr1e-3"
...
bash ${BASH_PATH} ${TASK} jurkat ${STAGE} ${CONFIG_NAME} 0 ba 0.001 &

bash ${BASH_PATH} ${TASK} hepg2 ${STAGE} ${CONFIG_NAME} 1 ba 0.001 &

bash ${BASH_PATH} ${TASK} k562 ${STAGE} ${CONFIG_NAME} 2 ba 0.001 &

bash ${BASH_PATH} ${TASK} rpe1 ${STAGE} ${CONFIG_NAME} 3 ba 0.001 &
