...
python -m state tx train \
    ...
    model.kwargs.extra_dataset_kwargs.p_val_threshold=${P_THRESHOLD} \
    model.kwargs.loss_kwargs.DE_loss_kwargs.use_DE_loss=${DE_DECODER} \
    model.kwargs.loss_kwargs.DE_loss_kwargs.weight=${DE_LOSS_WEIGHT} \
    model.kwargs.loss_kwargs.direction_loss_kwargs.use_direction_loss=${DIR_DECODER} \
    model.kwargs.loss_kwargs.direction_loss_kwargs.weight=${DIR_LOSS_WEIGHT} \
