...
# 实验 1: -> GPU 0
# name | gpu_id | sd_weight | mean_weight | cov_weight | test_dataset
bash ${BASH_PATH} lambda_0.5_2 0 1 0.5 2 jurkat ${STAGE} &

bash ${BASH_PATH} lambda_0.5_2 1 1 0.5 2 hepg2 ${STAGE} &

bash ${BASH_PATH} lambda_0.5_2 2 1 0.5 2 k562 ${STAGE} &

bash ${BASH_PATH} lambda_0.5_2 3 1 0.5 2 rpe1 ${STAGE} &
