...
# 实验 1: -> GPU 0
# name | gpu_id | sd_weight | mean_weight | cov_weight | test_dataset
bash ${BASH_PATH} 0.7_0.3 0 1 0.7 0.3 rpe1 ${STAGE} &

bash ${BASH_PATH} 0.5_2 1 1 0.5 2 jurkat ${STAGE} &

bash ${BASH_PATH} 0.5_2 2 1 0.5 2 hepg2 ${STAGE} &

bash ${BASH_PATH} 0.5_2 3 1 0.5 2 k562 ${STAGE} &

bash ${BASH_PATH} 0.5_2 4 1 0.5 2 rpe1 ${STAGE} &
