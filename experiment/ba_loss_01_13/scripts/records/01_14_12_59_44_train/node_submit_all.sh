...
# 第一轮 jurkat
# 实验 5: -> GPU 0
bash ${BASH_PATH} 0.3_0.7 0 1 0.3 0.7 jurkat ${STAGE} &

# 第二轮 hepg2
# 实验 1: -> GPU 1
bash ${BASH_PATH} 0.7_0.3 1 1 0.7 0.3 ${TEST_DATASET} ${STAGE} &

# 实验 2: -> GPU 2
bash ${BASH_PATH} 0.6_0.4 2 1 0.6 0.4 ${TEST_DATASET} ${STAGE} &
