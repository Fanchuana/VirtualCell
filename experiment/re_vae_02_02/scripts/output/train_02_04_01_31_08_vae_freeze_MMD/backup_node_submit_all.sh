...
# export STAGE=train
export STAGE=test
export CONFIG_NAME="vae_freeze_MMD"
...
bash ${BASH_PATH} ${TASK} jurkat ${STAGE} ${CONFIG_NAME} 0 energy &

bash ${BASH_PATH} ${TASK} hepg2 ${STAGE} ${CONFIG_NAME} 1 energy &

bash ${BASH_PATH} ${TASK} k562 ${STAGE} ${CONFIG_NAME} 2 energy &

bash ${BASH_PATH} ${TASK} rpe1 ${STAGE} ${CONFIG_NAME} 3 energy &
