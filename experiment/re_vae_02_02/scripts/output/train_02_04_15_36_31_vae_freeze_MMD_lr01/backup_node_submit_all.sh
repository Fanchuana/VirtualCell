...
# export STAGE=train
export STAGE=test
export CONFIG_NAME="vae_freeze_ourloss_lr01"
...
bash ${BASH_PATH} ${TASK} jurkat ${STAGE} ${CONFIG_NAME} 0 energy 0.01 &

bash ${BASH_PATH} ${TASK} hepg2 ${STAGE} ${CONFIG_NAME} 1 energy 0.01 &

bash ${BASH_PATH} ${TASK} k562 ${STAGE} ${CONFIG_NAME} 2 energy 0.01 &

bash ${BASH_PATH} ${TASK} rpe1 ${STAGE} ${CONFIG_NAME} 3 energy 0.01 &
