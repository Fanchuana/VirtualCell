...
# bash ${BASH_PATH} fewshot jurkat ${STAGE} vae_freeze_ourloss 0 &

# bash ${BASH_PATH} fewshot hepg2 ${STAGE} vae_freeze_ourloss 1 &

# bash ${BASH_PATH} fewshot k562 ${STAGE} vae_freeze_ourloss 2 &

# bash ${BASH_PATH} fewshot rpe1 ${STAGE} vae_freeze_ourloss 3 &
