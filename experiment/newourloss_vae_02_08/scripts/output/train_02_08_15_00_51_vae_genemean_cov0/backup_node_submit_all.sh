...
# export STAGE=train
export STAGE=test
export CONFIG_NAME="vae_genemean_cov0"
...
# task | test_dataset | train/test | config_name | gpu_id | gene_mean | cov_weight
bash ${BASH_PATH} ${TASK0} jurkat ${STAGE} ${CONFIG_NAME} 0 True 0 0 0 &

bash ${BASH_PATH} ${TASK0} k562 ${STAGE} ${CONFIG_NAME} 1 True 0 0 0 &

bash ${BASH_PATH} ${TASK1} jurkat ${STAGE} ${CONFIG_NAME} 2 True 0 0 0 &

bash ${BASH_PATH} ${TASK1} k562 ${STAGE} ${CONFIG_NAME} 3 True 0 0 0 &
